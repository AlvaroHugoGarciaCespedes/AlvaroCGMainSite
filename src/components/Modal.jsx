...
export default function Modal({ theme, styled, click, children, }) {
    ...
    function addService(e) {
        ...
        console.log(obj)
        e.target[0].files[0] && uploadIMG(`services/${filename}`, 'services', filename, e.target[0].files[0], obj, setUserData, setUserSuccess, 'url')
        e.target[0].files[0] === undefined && writeUserData(`services/${filename}`, obj, setUserData, setUserSuccess)
    }
                    ...
                    <div className="border-b border-gray-900/10 pb-12">
                        <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                            ...
                            <div className="sm:col-span-3">
                                ...
                                <input type="text" name="costo" id="first-name" className="block w-full rounded-md border-0 py-1.5 mt-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                            </div>
                            <div className="sm:col-span-3">
